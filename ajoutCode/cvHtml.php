<div class="divLong blanc" style="margin-top:-120px">
    <div class="divLong2 bleu" id="competences">
        ...
        <div class="texteOnlyG ">
            ...
            <br>
            <br><span class="titre3">HTML/CSS</span> 
            <br><span class="italique">Utilisation d'un framework front-end, Réalisation de la partie front-end d'applications Web</span>
            <br>
            <br><span class="titre3">PHP</span> 
            <br><span class="italique">Réalisation de la partie back-end d'applications Web</span>
            <br>
            <br><span class="titre3">Javascript</span>
            <br><span class="italique">Utilisation du framework JQuery, Utilisation d'Ajax</span>
            <br>
            <br><span class="titre3">C#</span> 
            <br><span class="italique">Réalisation d'une application d'automatisation de requêtes en base de données sans interface, Utilisation dans le cadre du développement d'un formulaire Infopath sur serveur Sharepoint</span>
            <br>
       ...
       <div class="texteOnlyD">
            ...
            <br><span class="italique">Création, gestion et exploitation de bases de données sous PostgreSql et MySQL, Utilisation de requêtes d'interrogation et d'administration, de triggers, de procédures stockées, de fonctions stockées et de curseurs</span>
            <br>
            <br><span class="titre3">Merise/2</span>
            <br><span class="italique">Création de schémas conceptuels de données à partir d'une base de données, d'un schéma relationnel ou d'un contexte donné, Utilisation de Win Design</span>
            <br>
            <br><span class="titre3">UML</span>
            <br><span class="italique">Création de diagrammes à partir d'une application ou d'un contexte donné, Utilisation de Win Design</span>
            <br>
            <br>
            <br>
            <br>
        ...
        <div class="texteOnlyG" style="margin-top:30px">
            ...
            <br><span class="italique">Drupal, Wordpress</span>
            <br>
            <br><span class="titre3">Versionning</span>
            <br><span class="italique">Utilisation de Git, GitHub et Bitbucket dans de nombreux projets</span>
            <br>
            <br><span class="titre3">Gestion des tests</span>
            <br><span class="italique">Utilisation de frameworks de tests unitaires, Réalisation de dossier de tests fonctionnels, Contrôle du fonctionnement d'une application</span>
            <br>
        ...
        <div class="texteOnlyD" style="margin-top:30px">
            ...
            <br><span class="italique">Niveau B2/C1, lecture de sites et de forums, visionnage de vidéos</span>
            <br>
            <br><span class="titre3">Japonais</span>
            <br><span class="italique">Notions à l'oral uniquement, pratique dans le cercle amical</span>
            <br>
            <br><span class="titre3">Espagnol</span>
            <br><span class="italique">Niveau B1</span>
            <br>
            <br>
            <br>
            <br>
    ...
    <div class="divLong2 rouge" id="experience">
        <div class="divLong2 rouge pad titre1">Expérience professionnelle</div>
        <div style="margin-left:6%; margin-top:-30px ;">
            ...
            <br><span class="italique">Développement d’un formulaire sous Infopath 2010 et Sharepoint 2010 afin d’informatiser des demandes d’études et de statistiques. 
                Etude du besoin - Rédaction de documentation technique et utilisateur - Développement de l’applicatif - Contact avec le client et présentation de l’applicatif.</span>
            <br>
    ...
    <div class="divLong2 blanc" id="formation">
        <div class="divLong2 blanc pad titre1">Formation</div>
        <div style="margin-left : 6%; margin-top:-30px ;">
            <br>
            <br><span class="titre3">2014-2016 : Préparation du BTS Services Informatiques aux Organisations spécialité Solutions Logicielles et Applications Métiers</span>
            <br><span>CNED</span>
            <br>
            <br><span class="titre3">2013 : Baccalauréat littéraire spécialité Mathématiques</span>
            <br><span>CNED</span>
            <br>

        </div>
        <div class="divCentre">
            <a href="#experience" class="scroll" title="Vers Experience"><img src="<?php echo bloginfo('url'); ?>/wp-content/uploads/2016/06/hautBlancB-e1464822830732.jpg" 
    ...
    <div class="divLong2 bleu" id="loisirs">
        ...
        <div style="margin-left : 6% ; margin-top:-30px ;">
            ...
            <br><span class="italique">Historique, Classique, Fantastique, Fantasy, Science-fiction</span>
            <br>
            <br><span class="titre3">Culture japonaise</span>
            <br><span class="italique">Musique, coutumes, langue, technologie, gastronomie, histoire</span>
            <br>
        </div>
        <div class="divCentre">
    ...
    <div class="divLong2 rouge" id="telechargement">
        <div class="divLong2 rouge pad titre1">Téléchargement</div>
        <div style="margin-left:6%;">

        </div>
        <div class="divCentre">
            <ul class="menuReaR">
                <li class="menuReaR"><a download href="http://telechargements.audreyguilbaud.fr/CvAudreyGuilbaud.pdf">Téléchargement PDF du CV</a></li> 
            </ul>
        </div>
